    ...
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section ref={featuresRef} className="py-20 md:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div key={i}
                className="group p-6 rounded-2xl border border-gray-100 bg-white hover:border-blue-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className={"w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-5 bg-gradient-to-br " + f.gradient}>
                  {f.icon}
                </div>
      ...
      <section className="py-16 relative overflow-hidden"
        ...
        <div className="absolute inset-0 opacity-10"
          style={{ backgroundImage: "radial-gradient(circle at 1px 1px, white 1px, transparent 0)", backgroundSize: "30px 30px" }}></div>
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 border border-white/30 rounded-full px-4 py-1.5 mb-6">
            <span className="text-white/80 text-xs font-medium">Limited time offer</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Start practicing for just Rs 9
          </h2>
          <p className="text-green-100/80 mb-8 text-lg">
            Message us on WhatsApp and get your mock test link and password within minutes.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={openWhatsApp}
              className="inline-flex items-center justify-center gap-3 bg-white text-green-700 font-bold px-8 py-4 rounded-2xl hover:bg-green-50 transition-all duration-300 hover:scale-105 shadow-xl text-base">
            ...
            <Link href="/login?role=student"
              className="inline-flex items-center justify-center gap-2 border-2 border-white/40 text-white font-semibold px-8 py-4 rounded-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              Already have access? Login
            </Link>
          </div>
          <p className="text-green-200/60 text-sm mt-5">+91 75595 73410</p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">Real feedback from students who cracked their exams with us.</p>
          </div>
            ...
            {reviews.map((r, i) => (
              <div key={i}
                ...
                <div className="flex items-center gap-1 mb-4">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg key={star} viewBox="0 0 20 20" className={"w-4 h-4 " + (star <= r.rating ? "fill-yellow-400" : "fill-gray-200")}>
      ...
      <section ref={aboutRef} className="py-20 md:py-28"
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Built for HP students, by HP students</h2>
            <p className="text-white/50 max-w-xl mx-auto">
              We understand the pressure of government exam preparation. That is why we built the most affordable and effective mock test platform in Himachal Pradesh.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
              ...
              <h3 className="font-bold text-white text-lg mb-3">Our Mission</h3>
              <p className="text-white/60 leading-relaxed text-sm">
                Make quality mock test preparation accessible to every student in Himachal Pradesh at the most affordable price. We support HPSSC, HPRCA, JOA IT, Patwari, JEE, NEET, and Banking exam aspirants.
              </p>
            ...
            <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
              ...
              <p className="text-white/60 text-sm mb-4">
                For mock test purchases, queries, or technical support — we are here to help.
              </p>
              <div className="space-y-3">
                <a href="mailto:rulebreakers299@gmail.com"
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm font-medium group-hover:text-blue-300 transition">rulebreakers299@gmail.com</p>
                  </div>
                </a>
                <button onClick={openWhatsApp}
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm font-medium group-hover:text-green-300 transition">+91 75595 73410</p>
                  </div>
                </button>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            <div className="sm:col-span-2 md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold text-sm"
                  style={{ background: "linear-gradient(135deg, #1e3a8a, #2563eb)" }}>H</div>
                <span className="font-bold text-white">HP <span style={{ color: "#FBBF24" }}>Exam Achievers</span></span>
              </div>
              <p className="text-gray-500 text-sm leading-relaxed">
                Himachal Pradesh most affordable mock test platform for government exam preparation.
              </p>
            </div>

            <div>
              <p className="font-semibold text-white mb-4 text-sm">Platform</p>
              <div className="space-y-2.5">
                <Link href="/login?role=student" className="block text-gray-500 hover:text-white transition text-sm">Student Login</Link>
                <Link href="/login?role=teacher" className="block text-gray-500 hover:text-white transition text-sm">Teacher Login</Link>
                <button onClick={() => scrollTo(featuresRef)} className="block text-gray-500 hover:text-white transition text-sm text-left">Features</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2.5">
                <button onClick={() => scrollTo(aboutRef)} className="block text-gray-500 hover:text-white transition text-sm text-left">About Us</button>
                <a href="mailto:rulebreakers299@gmail.com" className="block text-gray-500 hover:text-white transition text-sm">Contact</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2.5">
                <a href="mailto:rulebreakers299@gmail.com" className="block text-gray-500 hover:text-white transition text-sm break-all">rulebreakers299@gmail.com</a>
                <button onClick={openWhatsApp} className="block text-gray-500 hover:text-white transition text-sm text-left">WhatsApp: +91 75595 73410</button>
              </div>
            </div>
          </div>
